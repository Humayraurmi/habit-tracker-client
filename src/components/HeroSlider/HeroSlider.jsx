...
const HeroSlider = () => {
  ...
  // handleNext function is correct.
  const handleNext = () => {
  ...
  // handlePrev function is correct.
  const handlePrev = () => {
    setCurrentIndex((prevIndex) =>
        ...
        >
          <div className="text-center text-white max-w-2xl">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="px-8 py-3 bg-white text-blue-600 font-semibold rounded-full text-lg shadow-lg hover:bg-gray-100 transition-colors"
            >
